...
voiceTalking.parametersSettings = function () {
    //refactoring - maybe not the parameters for object creation, but the object itself should be returned
    let parameters = {};
...
voiceTalking._addRecognitionSettings = function(parameters) {
    ...
    if (parameters.recognitionTestUrl) {
        let recognitionTestButton = document.createElement('button');
        recognitionTestButton.textContent = 'Test voice recognition';
        recognitionTestButton.onclick = voiceTalking._openWindowByUrlFunction(parameters.recognitionTestUrl);
        voiceTalking._settingsWindow.appendChild(recognitionTestButton);
    }
}

voiceTalking._openWindowByUrlFunction = function (url) {
